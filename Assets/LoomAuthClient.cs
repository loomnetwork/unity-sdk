...
public class LoomAuthClient
{
    ...
    /// 
    /// <param name="redirectUrl">Url Auth0 should redirect to after a user signs in.</param>
    /// <returns></returns>
    public async Task<string> GetAccessTokenForNativeApp(string redirectUrl = "http://127.0.0.1:9999/auth/auth0/")
    {
    ...
    public async Task<LoomIdentity> GetLoomIdentity(string accessToken)
    {
        ...
        {
            return await CreateIdentity(accessToken, vaultStore);
        }
    }
    ...
    /// </summary>
    /// <returns>A new <see cref="LoomIdentity"/>.</returns>
